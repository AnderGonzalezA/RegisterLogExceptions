...
public class Menu {
	public static void main(String[] args) {
		...
		try {
								...
								while (askPassword) {
									...
									if (user.setPassword(password)) {
										...
										try {
											...
											System.err.println("Using FileWriter a file can't be attached by two methods at the same time.");
										}
										askPassword = false;
									} else {
			...
			System.err.println("The file 'src/userData2.txt' was not found.");
		} catch (IOException e) {
			System.err.println("It was not possible to create the file 'src/userData.txt'.");
		}
	}
}
